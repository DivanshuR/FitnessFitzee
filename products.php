...
<body>
		...
		<div class="main_wrapper">
			...
			<div id="shopping_cart">
					...
					<button id="myBtn" style="font-size:18px;">Login</button>
					<a href="admin_area/admin.php"><button id="myBtn1" style="font-size:18px;">Admin Login</button></a>
					</span>
...
window.onclick = function(event) {
    if (event.target == modal) {
        modal.style.display = "none";
			...
			<h2 style="text-align:center;">&copy; 2016 by Divanshu Rohatgi.All Right Reserved.</h2>
